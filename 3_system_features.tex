...
The \emph{document} view supports evidence modeling through annotation. Similar to IEW, the system provides a basic structure to assist analysts in containing and framing new data. In the
